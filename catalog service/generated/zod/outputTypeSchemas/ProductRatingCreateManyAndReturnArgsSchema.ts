...
export const ProductRatingCreateManyAndReturnArgsSchema: z.ZodType<Prisma.ProductRatingCreateManyAndReturnArgs> = z.object({
  data: z.union([ ProductRatingCreateManyInputSchema, ProductRatingCreateManyInputSchema.array() ]),
  skipDuplicates: z.boolean().optional(),
}).strict();

export default ProductRatingCreateManyAndReturnArgsSchema;
