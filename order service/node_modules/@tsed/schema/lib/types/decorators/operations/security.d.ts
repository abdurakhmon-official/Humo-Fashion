 ...
 * @operation
 */
export declare function Security(name: string, ...scopes: string[]): ClassDecorator & MethodDecorator;
/**
 * Add security metadata on the decorated method.
 *
 ...
 * @operation
 */
export declare function Security(security: OpenSpecSecurity): ClassDecorator & MethodDecorator;
