 ...
 * @pipe
 */
export function UseParamType(options) {
    return useDecorators(ParamFn((param) => {
    ...
    }), options.expression && UseParamExpression(options.expression), options.expression && Name(options.expression));
}
