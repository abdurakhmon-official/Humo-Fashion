...
export const ProductCreateWithoutFilesInputSchema: z.ZodType<Prisma.ProductCreateWithoutFilesInput> = z.object({
  id: z.uuid().optional(),
  name: z.string(),
...
export default ProductCreateWithoutFilesInputSchema;
