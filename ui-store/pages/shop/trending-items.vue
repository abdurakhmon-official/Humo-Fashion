            ...
            <div class="container relative">
                ...
                <div class="relative mt-3">
                    <ul class="tracking-[0.5px] mb-0 inline-block">
                        ...
                        <li class="inline-block uppercase text-[13px] font-bold text-primary" aria-current="page">trending items</li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <section class="relative md:py-24 py-16">
            <div class="container relative">
                ...
                <ShopGridProduct :productData="products"
                    :grid="'grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-6'" />
...
function getSortParams(): { key: string, order: 'asc' | 'desc' }[] {
    ...
    sorts.push({ key: 'like_count', order: 'desc' });
