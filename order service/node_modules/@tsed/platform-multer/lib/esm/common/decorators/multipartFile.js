import { Metadata, StoreMerge, useDecorators, useMethodDecorators } from "@tsed/core";
 ...
 * @input
 */
export function MultipartFile(name, maxCount) {
    return (...args) => {
        ...
        const decorators = useDecorators(InFile(name), useMethodDecorators(StoreMerge(PLATFORM_MULTER_OPTIONS, mapOptions(name, maxCount)), UseBefore(PlatformMulterMiddleware)), UseParam({
