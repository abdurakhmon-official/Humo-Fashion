import { decorateMethodsOf, decoratorTypeOf, DecoratorTypes, Store, UnsupportedDecoratorType } from "@tsed/core";
 ...
 * @operation
 */
export function AuthOptions(guardAuth, options = {}) {
    return (...args) => {
        switch (decoratorTypeOf(args)) {
            ...
            case DecoratorTypes.CLASS:
                decorateMethodsOf(args[0], (_, property) => {
