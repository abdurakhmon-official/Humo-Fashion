                        ...
                        <div class="p-6 rounded-md shadow dark:shadow-gray-800 bg-white dark:bg-slate-900">
                            <div class="border-b border-gray-100 dark:border-gray-700 pb-6">
                                <div class="md:flex justify-between">
                                    <div>
                                        <img :src="logoDark" class="block dark:hidden" alt="">
                                        <img :src="logoLight" class="hidden dark:block" alt="">
                                        <div class="flex mt-4">
                                            <i data-feather="link" class="h-4 w-4 me-3 mt-1"></i>
                                            <a href="https://1.envato.market/cartzio-vue" target="_blank"
                                                class="text-primary dark:text-white font-medium">https://1.envato.market/cartzio-vue</a>
                                        </div>
                                    </div>
                                        ...
                                        <ul class="list-none">
                                            ...
                                            <li class="flex ms-0 mt-3">
                                                ...
                                                <a href="mailto:contact@example.com"
                                                    class="text-slate-400">info@cartzio.com</a>
                                            </li>

                                            <li class="flex ms-0 mt-3">
                                                <i data-feather="phone" class="h-4 w-4 me-3 mt-1"></i>
                                                <a href="tel:+152534-468-854" class="text-slate-400">(+12)
                                                    1546-456-856</a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="md:flex justify-between">
                                    <div>
                                        <div class="text-slate-400 text-center md:text-start">
                                            <h6 class="mb-0">Customer Services : <a href="tel:+152534-468-854"
                                                    class="text-amber-500">(+12) 1546-456-856</a></h6>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-4 md:mt-0">
                                        <div class="text-slate-400 text-center md:text-end">
                                            <h6 class="mb-0">
                                                <NuxtLink to="/page-terms" target="_blank" class="text-primary">Terms &
                                                    Conditions</NuxtLink>
                                            </h6>
                                        </div>
                                    </div>
