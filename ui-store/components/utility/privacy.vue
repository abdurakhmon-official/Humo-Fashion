                ...
                <div class="md:w-3/4">
                    <div class="p-6 bg-white dark:bg-slate-900 shadow dark:shadow-gray-800 rounded-md">
                        ...
                        <p class="text-slate-400">There is now an abundance of readable dummy texts. These are usually
                            used when a text is required purely to fill a space. These alternatives to the classic Lorem
                        ...
                        <ul class="list-none text-slate-400 mt-4">
                            <li v-for="item in privacyData" :key="item" class="flex ms-0 mt-2"><i
