import { ancestorOf, ancestorsOf, classOf, isArray, isClass, isFunction, isObject, isPlainObject, isPrimitiveClass, nameOf, uniq } from "@tsed/core";
...
function mapGenerics(jsonSchema, generics) {
...
export class JsonSchema extends Map {
    ...
    constructor(obj = {}) {
         ...
         * @private
         */
        this.#isLocalSchema = false;
        this.#isCollection = false;
        this.#useRefLabel = false;
        if (obj) {
            this.assign(obj);
        }
    }
    ...
    get isNullable() {
        return !!this.get(VendorKeys.NULLABLE);
    }
    get isReadOnly() {
    ...
    getAllowedGroups() {
        return this.get(VendorKeys.ALLOWED_GROUPS);
    }
    getAllowedRequiredValues() {
        return this.$allow;
    }
    getGroups() {
        return this.get(VendorKeys.GROUPS);
    }
    getGroupsName() {
        return this.get(VendorKeys.GROUPS_NAME);
    }
    /**
    ...
    getGenericLabels() {
        const labels = this.get(VendorKeys.GENERIC_LABELS);
        ...
        return this.get(VendorKeys.GENERIC_LABELS);
    }
    getGenericOf() {
    ...
    isRequiredValue(property, value) {
