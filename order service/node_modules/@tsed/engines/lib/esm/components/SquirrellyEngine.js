...
let SquirrellyEngine = class SquirrellyEngine extends Engine {
    $compile(template, options) {
        ...
        return (options) => compile(options, this.engine);
    }
};
SquirrellyEngine = __decorate([
    ViewEngine("squirrelly")
], SquirrellyEngine);
export { SquirrellyEngine };
