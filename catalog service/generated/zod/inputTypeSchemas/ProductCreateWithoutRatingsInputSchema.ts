...
export const ProductCreateWithoutRatingsInputSchema: z.ZodType<Prisma.ProductCreateWithoutRatingsInput> = z.object({
  id: z.uuid().optional(),
  name: z.string(),
...
export default ProductCreateWithoutRatingsInputSchema;
