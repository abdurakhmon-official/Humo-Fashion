...
export declare class GlobalProviderRegistry extends Map<TokenProvider, Provider> {
     ...
     * @param options
     */
    merge(target: TokenProvider, options: Partial<ProviderOpts>): Provider<any>;
    /**
    ...
    createRegistry(type: string | symbol, model: Type<Provider>, options?: Partial<RegistrySettings>): this;
    getRegistrySettings(target: TokenProvider): RegistrySettings;
    protected createProvider(key: TokenProvider, options: Partial<ProviderOpts<any>>): Provider<any>;
    /**
     *
     * @param key
     * @param options
