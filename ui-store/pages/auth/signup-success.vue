                    ...
                    <div class="lg:w-2/5">
                        <div
                            ...
                            <div class="px-6 py-12 text-center">
                                ...
                                <p class="text-slate-400 mt-4">Your account has been successfully created. <br /> Enjoy
                                    your journey. Thank you</p>

                                <div class="mt-6">
                                    <NuxtLink to="/"
                                        class="py-2 px-5 inline-block tracking-wide align-middle duration-500 text-base text-center bg-primary text-white rounded-md">
                                        Continue</NuxtLink>
                                </div>
                            </div>

                            <div class="text-center p-6 border-t border-gray-100 dark:border-gray-700">
                                <p class="mb-0 text-slate-400">© {{ date }} Humo Fashion. Easy & Online Shopping with <i
                                        class="mdi mdi-heart text-primary-600"></i> by <a href="https://shreethemes.in/"
