export declare function bindValue(target: any, propertyKey: string | symbol, expression: string, defaultValue?: any): void;
/**
 ...
 * @decorator
 */
export declare function Value(expression: string, defaultValue?: unknown): PropertyDecorator;
